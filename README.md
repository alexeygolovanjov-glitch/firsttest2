...
Легкий личный кино-сайт для одного пользователя: поиск через Kinopoisk API,
автоподбор плееров через KinoBD, локальная библиотека, статусы, рейтинг и заметки.
